...
class ImageProcessor(QThread):
    ...
    def apply_salt_and_pepper(self, image, noise_density):
    ...
    def run(self):
        ...
        noisy_image = self.apply_salt_and_pepper(self.image, self.noise_level)
        
        # Edge detection
        self.progress.emit(66)
        edge_image = self.sobel_edge_detection(self.image)
...
class ImageProcessingApp(QMainWindow):
    ...
    def noise_level_changed(self, value):
    ...
    def update_processed_images(self, noisy_image, edge_image):
